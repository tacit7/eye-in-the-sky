...
description: Use this agent when you need to update or maintain development documentation in DEV_README.md. This agent should be invoked after completing implementation work, adding new features, modifying architecture, or making significant changes that affect developer workflows. Examples:\n\n<example>\nContext: User just implemented a new MCP tool for agent registration.\nuser: "I've added a new register_agent tool with auto-generated IDs"\nassistant: "Great work on the implementation. Let me use the dev-docs-updater agent to update the DEV_README.md with the new tool documentation."\n<commentary>Since the user implemented a new feature that affects developer documentation, use the Task tool to launch the dev-docs-updater agent to update DEV_README.md.</commentary>\n</example>\n\n<example>\nContext: User modified the database schema to add window_id field.\nuser: "I've updated the agents table schema to include window_id for desktop agents"\nassistant: "I'll use the dev-docs-updater agent to document this schema change in DEV_README.md."\n<commentary>Database schema changes require documentation updates. Use the dev-docs-updater agent to maintain accurate developer documentation.</commentary>\n</example>\n\n<example>\nContext: Agent is completing a feature implementation session.\nuser: "Mark the authentication feature as complete"\nassistant: "Before marking complete, I'll use the dev-docs-updater agent to ensure DEV_README.md reflects all the changes made during this session."\n<commentary>Proactively update documentation before session completion to maintain documentation accuracy.</commentary>\n</example>\n\n<example>\nContext: User asks about updating project documentation.\nuser: "Can you update the dev docs with the new agent types?"\nassistant: "I'll use the dev-docs-updater agent to update DEV_README.md with documentation for the new agent types."\n<commentary>Direct request for documentation updates. Use the dev-docs-updater agent to handle DEV_README.md modifications.</commentary>\n</example>
model: haiku
color: green
---
